...
class WorkerControllerTest {
    ...
    public void testUpdateWorker() throws Exception {
        Mockito.when(workerService.updateWorker(eq(1L), any(WorkerDTO.class))).thenReturn(sampleWorker);
    ...
    public void testGetAllWorkers() throws Exception {
        ...
        Mockito.when(workerService.getAllWorkers()).thenReturn(workers);
    ...
    public void testGetById() throws Exception {
        Mockito.when(workerService.getWorkerById(1L)).thenReturn(sampleWorker);
